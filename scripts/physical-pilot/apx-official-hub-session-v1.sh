...
readonly CONFIG=/home/apx/.config/hypr/hyprland.lua
...
[[ -f $CONFIG && ! -L $CONFIG ]]
[[ -x /usr/bin/start-hyprland && -x /usr/bin/kitty ]]
...
/usr/bin/setpriv \
  ...
  DBUS_SESSION_BUS_ADDRESS=unix:path="$RUNTIME/bus" AQ_DRM_DEVICES=/dev/dri/card2 \
