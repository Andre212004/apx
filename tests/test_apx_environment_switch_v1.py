...
class EnvironmentSwitchV1Tests(unittest.TestCase):
    ...
    def test_contract_accepts_catalog_identity_and_typed_target(self) -> None:
        ...
        self.assertEqual(len(creation_payload["modules"]), 14)
    ...
    def test_workload_shell_surfaces_return_failure(self) -> None:
        ...
        self.assertIn('PopupWindow {\n        id: popup', source)
        self.assertIn('sequence: "Escape"', source)
        self.assertIn('grabFocus: false', source)
        ...
        self.assertIn('anchor.edges: Edges.Bottom', source)
        self.assertIn('anchor.gravity: Edges.Bottom', source)
        self.assertIn('popup.anchor.item = target', source)
        ...
        self.assertIn('keyboardFocused: root.environmentCreateFocusIndex === 10 + root.environmentModuleIndex(moduleInfo.key)', source)
        ...
        self.assertIn('Atalhos APX · SUPER+A / SUPER+E', source)
        self.assertIn('apx-shortcuts-v1", "toggle"', source)
